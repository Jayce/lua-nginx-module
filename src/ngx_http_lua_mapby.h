...
ngx_int_t ngx_http_lua_map_handler_inline(ngx_http_request_t *r, ngx_http_variable_value_t *v,
    uintptr_t data);
ngx_int_t ngx_http_lua_map_handler_file(ngx_http_request_t *r, ngx_http_variable_value_t *v,
    uintptr_t data);
